...
import { t as n } from "./gsap-CjUXhbIO.js";
import { t as r } from "./ScrollTrigger-DW7wmIBN.js";
...
function y(e, t = e >= 1e6) {
	return e === 0 ? "0 PLN" : t ? `${new Intl.NumberFormat("pl-PL", { maximumFractionDigits: 0 }).format(e / 1e6)} mPLN` : `${v(e)} PLN`;
}
function b(e, t) {
